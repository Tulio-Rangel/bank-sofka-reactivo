...
class AuditServiceTest {
    ...
    void registerDepositShouldCreateAuditTransaction() {
        ...
        expectedTransaction.setUserId(USER);
        ...
        // Act & Assert
        StepVerifier.create(auditService.registerDeposit(USER, initialBalance, depositAmount, finalBalance))
                .expectNextMatches(transaction ->
                        transaction.getUserId().equals(USER) &&
    ...
    void registerWithdrawalShouldCreateAuditTransaction() {
        ...
        // Act & Assert
        StepVerifier.create(auditService.registerWithdrawal(USER, initialBalance, withdrawalAmount, finalBalance))
                .expectNextMatches(transaction ->
                        transaction.getUserId().equals(USER) &&
                                transaction.getInitialBalance().equals(initialBalance) &&
